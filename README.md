...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyapetnet-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14592&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyapetnet-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyapetnet` can be installed with:

```
conda install pyapetnet
```

It is possible to list all of the versions of `pyapetnet` available on your platform with:
